...
public class EmpDeptSalgradeTests
{
    ...
    public void ShouldReturnEmployeesFromChicago()
    {
        ...
        List<Emp> result = emps.Where(empl => depts
            .Where(d => d.Loc == "CHICAGO")
            .Select(d => d.DeptNo)
            .ToList()
            .Contains(empl.DeptNo)
            ).ToList();
    ...
    public void ShouldMatchEmployeeToSalaryGrade()
    {
        ...
        //grupujemy bo agregaty (min,max,abg itp) dotycza grupy danych a nie jednego rekordu
        var result = emps
